      ...
      {label && (
        <StayledLabel
          className={clsx(
            ...
            labelstyle
              ? labelstyle
              : "text-sm sm:text-base font-semibold align-items-center pb-2 flex-no-wrap flex-grow-0 break-normal"
          )}
      ...
      <div className={Var.errorstyle}>
        <div
          className={clsx(
            ...
            "outline content-center p-1 my-2 border rounded-md",
            "transition duration-200 focus:bg-white",
            isError
              ? " border-red-500 "
              : " border-gray-200 focus-within:border-blue-500 hover:border-blue-500",
            className
          )}
        >
          {icon && (
            <label className="mx-1 font-normal text-xs my-auto align-content-center">
              <FontAwesomeIcon
          ...
          <input
            ...
            className={clsx(
              "mx-1 w-full text-gray-700",
              "my-auto placeholder-gray-500 bg-transparent",
